...
public class Validator extends PlainDocument {
   ...
   *
   * @param newLimit: maximale Anzahl der einzugebenen Zeichen
   */
  ...
  /**
   * Überprüft, ob eine Zahl eingegeben wurde und das nicht mehr als 10 Ziffern
  ...
  /**
   * Erlaubt sind nur Eingaben von 1- oder 2-stellige Zahlen mit 1
   * Nachkommastelle getrennt durch einen Punkt
   *
   * @return boolean
   * @param text Zu überprüfender Text.
   */
