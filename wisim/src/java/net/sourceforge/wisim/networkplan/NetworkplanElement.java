...
public class NetworkplanElement {
  ...
  private ArrayList<Integer> parentBasket;
  private ArrayList<Integer> childBasket;
  ...
  /**
   * Class representating one networkplan element. The user sets the child
   * elements of the activity. The parent elements are calculated.
   *
  ...
  public NetworkplanElement(int number, double duration, int[] child, String description) {
    ...
    this.child = child;
    parentBasket = new ArrayList<>();
    childBasket = new ArrayList<>();
  ...
  /**
   * Class representating one networkplan element. The user sets the parent
   * elements of the activity. The child elements are calculated. wants to set
   * the parents and not the childs.
   *
   ...
   * @return parentBasket
   */
  public ArrayList<Integer> getParentBasket() {
    return parentBasket;
  }
   ...
   * @param parentBasket
   */
  public void setParentBasket(ArrayList<Integer> parentBasket) {
   ...
   * @param childBasket
   */
  public void setChildBasket(ArrayList<Integer> childBasket) {
  ...
  public void getFromParentBasket() {
    ...
    while (parentBasketIt.hasNext()) {
      parent[i] = ((Integer) parentBasketIt.next());
      i++;
    }
  }
  ...
  public void getFromChildBasket() {
    ...
    while (childBasketIt.hasNext()) {
      child[i] = ((Integer) childBasketIt.next());
      i++;
    }
  }
   ...
   * position within the array of the JPanels displaying the networkplan
   * elements
   *
   * @return
   */
  ...
  /**
   * @param childSet TRUE if the user has set the child's in the constructor
   */
   ...
   */
  public ArrayList<Integer> getChildBasket() {
    return childBasket;
  }
