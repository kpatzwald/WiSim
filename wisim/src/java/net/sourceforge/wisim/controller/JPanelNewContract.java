...
public class JPanelNewContract extends JPanel {
  ...
  /**
   * Method pruefeSkontofrist. Überprüft, ob eine Zahl und das etwas eingegeben
   * wurde. Wenn vom Benutzer etwas falsches eingegeben wurde, wird er zu
   * Korrektueingabe aufgefordert.
   */
  ...
  /**
   * Method pruefeSkonto. Überprüft, ob ein korrekter Skontowert eingegeben
   * wurde. Wenn vom Benutzer etwas falsches eingegeben wurde, wird er zu
   * Korrektueingabe aufgefordert.
   */
  ...
  /**
   * Method pruefeRabatt. Überprüft, ob ein korrekter Rabattwert eingegeben
   * wurde. Wenn vom Benutzer etwas falsches eingegeben wurde, wird er zu
   * Korrektueingabe aufgefordert.
   */
   ...
   * Wenn vom Benutzer etwas falsches eingegeben wurde, wird er zu
   * Korrektueingabe aufgefordert.
   */
  ...
  /**
   * Method pruefeLieferdatumMonat. Überprüft den eingegebenen
   * Lieferdatumsmonat. Wenn vom Benutzer etwas falsches eingegeben wurde, wird
   * er zu Korrektueingabe aufgefordert.
   */
  ...
  /**
   * Method pruefeAbnahmemenge. Überprüft die Abnahmemenge. Wenn der Benutzer
   * etwas falsche eingibt, wird er zur Korrektureingabe gefordert.
   */
  ...
  /**
   * Method ladeKundendaten. Lädt den Kundentyp, Zahlungsmoral und Ansprüche zum
   * ausgewählten Kunden aus der Hashtable kundeObjekt.
   */
  ...
  /**
   * Method ladeStueckpreis. Lädt von dem ausgewähltem Article den Stückpreis
   * aus der Datenbank.
   */
  ...
  private void saveContract() {
    ...
    vertrag.setSkontofrist(Long.parseLong(jTextFieldSkontofristTage.getText()));
