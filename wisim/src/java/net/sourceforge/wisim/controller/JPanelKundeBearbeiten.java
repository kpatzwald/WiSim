 ...
 * @author Christian Drechsler
 */
public class JPanelKundeBearbeiten extends javax.swing.JPanel {
     ...
     */
    public JPanelKundeBearbeiten(WiSimMainController wiSimMainController) {
        ...
        if (auswahl == 0){
            ...
            if (!check.isEmpty()) {
                if (check.size() > 1)
                    ...
                    + check.toString().substring(1,check.toString().length()-1), "Fehler beim Speichern des Kunden", JOptionPane.ERROR_MESSAGE);
                else
