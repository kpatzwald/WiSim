...
public class ShowNetzplan extends javax.swing.JFrame {
	...
	public ShowNetzplan() {
		...
		npElemente.add(new NetzplanElement(2, 2, new int[] { 4,5 }, "Ausgießen Fundamente"));
		...
		npElemente.add(new NetzplanElement(2, 2, new int[] { 3, 4 }, "Ausgießen Fundamente"));
	...
	*/
	private void initComponents() {
		...
		jScrollPane1.setBounds(0, 0, 993, 775);
