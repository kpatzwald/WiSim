...
public class JPanelModifySupplier extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    jLabelArtikelPreis1.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jTextFieldLieferantBearbeitenArtikelPreis.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
    ...
    jTextFieldLieferantBearbeitenArtikelPreis.setBounds(130, 370, 190, 26);

    jButtonLieferantBearbeitenArtikelHinzufuegen.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
    ...
    jButtonLieferantBearbeitenArtikelHinzufuegen.setBounds(340, 340, 60, 29);

    jButtonLieferantBearbeitenArtikelEntfernen.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
    ...
    jButtonLieferantBearbeitenArtikelEntfernen.setBounds(340, 390, 60, 29);

    jLabelMindestAbnahme3.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jTextFieldLieferantBearbeitenMindestAbnahme.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
    ...
    jTextFieldLieferantBearbeitenMindestAbnahme.setBounds(130, 400, 190, 26);
    ...
    jComboBoxLieferantBearbeiten.setBounds(130, 60, 250, 27);
    ...
    jLabelNeuerLieferantName.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jLabelNeuerLieferantVorname.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jTextFieldNeuerLieferantStrasse.setBounds(130, 130, 250, 26);

    jLabelNeuerLieferantStrasse.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jTextFieldNeuerLieferantFirma.setBounds(130, 100, 250, 26);

    jLabelLieferantenFirma.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jLabelNeuerLieferantOrt.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jTextFieldNeuerLieferantOrt.setBounds(130, 160, 160, 26);

    jLabelNeuerLieferantPLZ.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jTextFieldNeuerLieferantPLZ.setBounds(330, 160, 50, 26);
    ...
    jLabelNeuerLieferantFax.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jLabelNeuerLieferantTelefon.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jLabelNeuerLieferantEMail.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jLabelNeuerLieferantLieferqualitaet.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jComboBoxNeuerLieferantLieferqualitaet.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jComboBoxNeuerLieferantZuverlaessigkeit.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jLabelNeuerLieferantZuverlaessigkeit.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    ...
    jComboBoxNeuerLieferantArtikel.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
    add(jComboBoxNeuerLieferantArtikel);
    jComboBoxNeuerLieferantArtikel.setBounds(130, 330, 190, 27);
    ...
    jLabelNeuerLieferantLieferqualitaet1.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
    ...
    jLabelNeuerLieferantLieferqualitaet2.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
    ...
    jLabelLieferantBearbeitenUeberschrift.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
  ...
  private void loadSuppliers() {
    Collection<Supplier> lieferantenliste = null;
    try {
      lieferantenliste = dao.getSuppliers();
  ...
  private void loadSpareParts() {
    Collection<WiSimComponent> teile = null;
    try {
      teile = dao.getAllComponents();
    } catch (WiSimDAOException e) {
  ...
  private void deleteDependingSpareParts(int id) {
    ...
    try {
      Collection<SupplyList> lieferliste = dao.getSupplyLists(id);
      for (SupplyList liste : lieferliste) {

        dao.getComponent(liste.getEinzelteilID()); //dispensable?
  ...
  private void loadDependingSpareParts(int id) {
    ...
    try {
      ...
      for(SupplyList liste : lieferliste) {
        ...
        ArrayList<String> tableTempRow = new ArrayList<>();
        int row = 0;
        ...
        jTable1.setValueAt(format.format(liste.getPreis()), position, 2);
        position++;
  ...
  private javax.swing.JComboBox<String> jComboBoxNeuerLieferantLieferqualitaet;
  private javax.swing.JComboBox<String> jComboBoxNeuerLieferantZuverlaessigkeit;
