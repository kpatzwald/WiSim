...
public class JPanelViewCustomers extends javax.swing.JPanel {
	...
	private void initComponents() {//GEN-BEGIN:initComponents
		...
		jTableKunden.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
		}, new String[] { "Kunden" }) {
	...
	private void loadCustomers() {
		try {
			...
			while (it_kunden.hasNext()) {
				...
				ArrayList tableTempRow = new ArrayList();
				row = 0;
	...
	public void updateCustomerTable(boolean delete) {
		...
		DefaultTableModel defTable = new DefaultTableModel(tableInit, new String[] { "Kunden" }) {
			boolean[] canEdit = new boolean[] { false };
