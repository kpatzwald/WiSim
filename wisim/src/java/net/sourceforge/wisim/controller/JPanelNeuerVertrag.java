 ...
 */
public class JPanelNeuerVertrag extends JPanel {
	...
	private void initComponents() { //GEN-BEGIN:initComponents
		...
		jPanel1.add(jPanel2);
		jPanel2.setBounds(30, 60, 310, 140);

		add(jPanel1);
		jPanel1.setBounds(40, 50, 360, 210);
		...
		jTextFieldNeuerVertragAbnahmemenge.setDocument(new JTextFieldValidation(10));
		...
		jPanel3.add(jTextFieldNeuerVertragAbnahmemenge);
		...
		jPanel3.add(jTextFieldNeuerVertragIntermediateResult1);
		...
		jPanel3.add(jTextFieldNeuerVertragStueckpreis);
		...
		jLabelEUR2.setText("\u20ac");
		jPanel3.add(jLabelEUR2);
		jLabelEUR2.setBounds(310, 100, 10, 20);

		add(jPanel3);
		jPanel3.setBounds(410, 50, 340, 210);
		...
		add(jPanel5);
		jPanel5.setBounds(40, 270, 360, 230);
		...
		jPanel6.add(jLabelZwischensumme2);
		...
		jPanel6.add(jTextFieldNeuerVertragIntermediateResult2);
		...
		jPanel6.add(jTextFieldNeuerVertragAngebotspreisOhneSkonto);
		...
		jPanel6.add(jTextFieldNeuerVertragIntermediateResult3);
	 ...
	 * aufgefordert.
	 */
	private void pruefeSkontofrist() {
		...
		if (!rabatt.equals("") && rabatt != null) {
			...
			while (!rabattOk && rabatt != null) {
				...
				if (!validate.checkProzent(rabatt)) {
					jOptionPaneConfirm.setWantsInput(true);
					rabatt = JOptionPane.showInputDialog(this, "Ungültiger Rabatt (Format: x.y)! Bitte neu eingeben:", rabatt);
	 ...
	 * aufgefordert.
	 */
	private void pruefeLieferdatumTag() {
	 ...
	 * aufgefordert.
	 */
	private void pruefeLieferdatumMonat() {
	 ...
	 * aufgefordert.
	 */
	private void pruefeLieferdatumJahr() {
	...
	private double getDiscount() {
		...
		if (!jTextFieldRabatt.getText().equals("")) {
			...
			discount = Double.parseDouble(jTextFieldRabatt.getText());
	...
	private double getCashDiscount() {
		...
		if (!jTextFieldSkonto.getText().equals("")) {
			...
			cashDiscount = Double.parseDouble(jTextFieldSkonto.getText());
	...
	/** Überprüft alle Pflichtfelder auf Inhalt. Gibt eine Fehlemeldung
	   ...
	   */
	private boolean ueberpruefenFelder() {
	...
	/** Überprüft das eingegebene Lieferdatum
	   ...
	   * Datum ungültig ist.
	   */
	private GregorianCalendar ueberpruefeLieferdatum() {
	...
	private void speicherVertrag() {
		...
		vertrag.setRabatt(Double.parseDouble(jTextFieldRabatt.getText().toString()));
		vertrag.setSkonto(Double.parseDouble(jTextFieldSkonto.getText().toString()));
