...
public class JPanelNewSupplier extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    jLabelUeberschriftNeuerLieferant.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
    ...
    jLabelLieferantenFirma.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jLabelUeberschriftArtikelBearbeiten.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
    ...
    jLabelUeberschriftArtikelBearbeiten.setBounds(0, 260, 800, 20);
    ...
    jLabelNeuerLieferantArtikel.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jLabelNeuerLieferantArtikelPreis.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jTextFieldNeuerLieferantPreis.setDocument(new Validator(10));
    ...
    jTextFieldNeuerLieferantPreis.setBounds(150, 330, 80, 26);
    ...
    jButtonNeuerLieferantArtikelHinzufuegen.setBounds(350, 300, 60, 29);
    ...
    jButtonNeuerLieferantArtieklEntfernen.setBounds(350, 350, 60, 29);

    jLabelNeuerLieferantMindestAbnahme.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jTextFieldNeuerLieferantMindestAbnahme.setDocument(new Validator(10));
    ...
    jTextFieldNeuerLieferantMindestAbnahme.setBounds(150, 360, 80, 26);

    jTextFieldNeuerLieferantFirma.setDocument(new Validator(50));
    add(jTextFieldNeuerLieferantFirma);
    jTextFieldNeuerLieferantFirma.setBounds(140, 80, 210, 26);

    jLabelNeuerLieferantZuverlaessigkeit.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jLabelNeuerLieferantLieferqualitaet.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jButtonLieferantenAnlegen.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
    ...
    jButtonLieferantenAnlegen.setBounds(310, 420, 190, 29);

    jLabelNeuerLieferantName.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jTextFieldNeuerLieferantName.setBounds(140, 50, 210, 26);

    jLabelNeuerLieferantVorname.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jTextFieldNeuerLieferantVorname.setBounds(480, 50, 210, 26);

    jLabelNeuerLieferantStrasse.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jTextFieldNeuerLieferantStrasse.setBounds(480, 80, 210, 26);

    jLabelNeuerLieferantOrt.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jTextFieldNeuerLieferantOrt.setBounds(140, 110, 210, 26);

    jLabelNeuerLieferantPLZ.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jTextFieldNeuerLieferantPLZ.setBounds(480, 110, 40, 26);

    jLabelNeuerLieferantEMail.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jTextFieldNeuerLieferantEMail.setBounds(140, 170, 210, 26);

    jLabelNeuerLieferantTelefon.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jLabelNeuerLieferantFax.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    jTextFieldNeuerLieferantTelefon.setBounds(140, 140, 210, 26);

    jTextFieldNeuerLieferantFax.setDocument(new Validator(30));
    add(jTextFieldNeuerLieferantFax);
    jTextFieldNeuerLieferantFax.setBounds(480, 140, 210, 26);
    ...
    jComboBoxNeuerLieferantLieferqualitaet.setBounds(480, 170, 50, 27);
    ...
    jComboBoxNeuerLieferantZuverlaessigkeit.setBounds(480, 210, 50, 27);
    ...
    jComboBoxNeuerLieferantArtikel.setBounds(150, 300, 180, 27);
    ...
    add(jLabel1);
    jLabel1.setBounds(230, 330, 20, 20);
  ...
  private void checkNewSupplier() {
    ArrayList<String> check = checkFormLieferant();
    if (check.isEmpty()) {
      newSupplier();
    } else {
      if (check.size() > 1) {
  ...
  private void newSupplier() {
    ...
    if (lieferantenID > 0 && model.getSize() > 0) {
      for (int i = 0; i < model.getSize(); i++) {
        ...
        String price = eingabe[0];
        if (price.matches("^[0-9]*[,][0-9]*")) {
          price = price.replaceAll(",", ".");
        }
        liste.setPreis(Double.parseDouble(price));
   ...
   * @return Vector
   */
  private ArrayList<String> checkFormLieferant() {
  ...
  /**
   * Diese Funktion löscht das Formular nach Betätigung des Buttons "Lieferanten
   * anlegen"
   *
   * @author Kay Patzwald
   */
  ...
  private javax.swing.JComboBox<String> jComboBoxNeuerLieferantArtikel;
  ...
  private javax.swing.JList<String> jListNeuerLieferantArtikel;
